        ...
        <div
            ...
            <main class="sm:pb-8 pb-4">
                ...
                <ul class="list-disc list-inside">
                    <li>
                        <x-a href="https://www.eduid.cz/cs/tech/attributes/cn">cn</x-a> ({{ __('welcome.cn') }})
                    </li>
                    <li>
                        <x-a href="https://www.eduid.cz/cs/tech/attributes/edupersonuniqueid">uniqueId</x-a>
                        ({{ __('welcome.uniqueid') }})
                    </li>
                    <li>
                        <x-a href="https://www.eduid.cz/cs/tech/attributes/mail">mail</x-a> ({{ __('welcome.mail') }})
                    </li>
                </ul>
            ...
            <footer>
                ...
                <p class="text-center opacity-75">
                    <small class="text-sm">
                        <x-a href="{{ __('welcome.pii-link') }}">{{ __('welcome.pii-text') }}</x-a><br>
